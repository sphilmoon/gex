...
pbmc <- readRDS(file = "/home/Desktop/annotation_working.rds")
...
cd_genes <- c("Cd4", "Ifng", "Tnf", "Foxp3", "Ahr", "Ccr7", "Ccr3", "Ccr5", "Ccr6", "Cxcr3", "Icos", "Il18", "Il21", "Lag3", "Lrrc32")
...
VlnPlot(T_cell_subset, features = c("Cd4", "Ifng", "Tnf", "Foxp3", "Ahr", "Ccr7", "Ccr3"), pt.size = 0.3, group.by = "orig.ident")  
FeaturePlot(T_cell_subset, features = c("Cd4", "Ifng", "Tnf", "Foxp3", "Ahr", "Ccr7", "Ccr3"), pt.size = 0.3) & 
